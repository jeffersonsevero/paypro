                    ...
                    <form action="{{ route('payment.handle') }}" method="post" x-data={}>
                        ...
                        <div class="mt-4 grid grid-cols-1 gap-5 md:grid-cols-2">
                            <div>
                                ...
                                <x-text-input x-mask:dynamic="$money($input, ',')" id="price"
                                    class="block mt-1 w-full" type="text" name="price" :value="old('price')" />
                                <x-input-error :messages="$errors->get('price')" class="mt-2" />
                            </div>

                            <div>
                                <label for="payment-type"
                                    class="block text-sm font-medium leading-6 text-gray-900">Forma de pagamento</label>
